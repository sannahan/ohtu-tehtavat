...
public class IntJoukkoTest {
    ...
    public void vainLisatytLuvutLoytyvat() {
        assertTrue(joukko.lukuLoytyyTaulukosta(10));
        assertFalse(joukko.lukuLoytyyTaulukosta(5));
        assertFalse(joukko.lukuLoytyyTaulukosta(0));
        assertTrue(joukko.lukuLoytyyTaulukosta(3));
    }

    @Test
    public void poistettuEiOleEnaaJoukossa() {
        joukko.poista(3);
        assertFalse(joukko.lukuLoytyyTaulukosta(3));
    ...
    public void toimiiKasvatuksenJalkeen(){
        ...
        assertTrue(joukko.lukuLoytyyTaulukosta(11));
        joukko.poista(11);
        assertFalse(joukko.lukuLoytyyTaulukosta(11));
